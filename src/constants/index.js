...
export const COMMAND_ITEMS = [
  { label: 'Go to Home', action: 'hero', category: 'Navigation' },
  { label: 'Go to About', action: 'about', category: 'Navigation' },
  { label: 'Go to Skills', action: 'skills', category: 'Navigation' },
  { label: 'Go to Experience', action: 'experience', category: 'Navigation' },
  { label: 'Go to Projects', action: 'projects', category: 'Navigation' },
  { label: 'Go to Contact', action: 'contact', category: 'Navigation' },
  { label: 'Download Resume', action: 'resume', category: 'Actions' },
  { label: 'Toggle Theme', action: 'theme', category: 'Actions' },
  { label: 'Copy Email', action: 'email', category: 'Actions' },
  { label: 'View GitHub', action: 'github', category: 'Social' },
  { label: 'View LinkedIn', action: 'linkedin', category: 'Social' },
]
